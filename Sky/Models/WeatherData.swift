...
struct WeatherData: Codable {
    ...
    static let invalid = WeatherData(latitude: 0, longitude: 0, currently: CurrentWeather(time: Date(), summary: "n/a", icon: "n/a", temperature: 0, humidity: 0), daily: WeekWeatherData(data: []))
}
